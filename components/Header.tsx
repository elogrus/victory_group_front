        ...
        <header className="h-14 border-b flex items-center justify-between px-4 bg-background shrink-0 relative z-50">
            ...
            <div className="flex items-center gap-3">
                <div className="relative w-48 hidden md:block">
                    ...
                    <input
                        placeholder="Поиск"
                        className="w-full bg-muted/50 border border-transparent focus:border-blue-500 rounded-md pl-8 h-8 outline-none text-sm transition-all"
                    />
                </div>
                <Button
                    variant="ghost"
                ...
                <div className="relative">
                    <button
                        ...
                        className="w-8 h-8 rounded-full bg-blue-800 text-white text-xs font-bold flex items-center justify-center ml-1 ring-2 ring-transparent hover:ring-blue-500"
                    >
                        DK
                    </button>
                    ...
                    {menuOpen && (
                        <div className="absolute right-0 top-10 w-64 bg-popover border rounded-md shadow-lg py-2 flex flex-col text-sm z-50">
                            ...
                            <button className="flex items-center gap-3 px-4 py-2 hover:bg-muted text-left text-foreground">
                            ...
                            <button
                                onClick={toggleTheme}
                                className="flex items-center justify-between px-4 py-2 hover:bg-muted text-left text-foreground"
                            >
                                <div className="flex items-center gap-3">
                                    {isDark ? (
                            ...
                            <div className="border-t mt-2 pt-2">
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-4 py-2 hover:bg-muted text-left text-foreground"
                                >
