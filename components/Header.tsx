    ...
    <header className="h-14 border-b flex items-center justify-between px-4 bg-background shrink-0 relative z-50">
      <div className="flex items-center gap-4">
        ...
        <nav className="hidden xl:flex gap-5 ml-6 text-sm font-medium text-muted-foreground">
          <a href="#" className="hover:text-foreground">Ваша работа</a>
          <a href="#" className="hover:text-foreground">Проекты</a>
          <a href="#" className="hover:text-foreground">Фильтры</a>
          <a href="#" className="hover:text-foreground">Дашборды</a>
          <a href="#" className="hover:text-foreground">Команды</a>
          <a href="#" className="hover:text-foreground">Приложения</a>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button onClick={() => setMenuOpen(!menuOpen)} className="w-8 h-8 rounded-full bg-blue-800 text-white text-xs font-bold flex items-center justify-center ml-1 ring-2 ring-transparent hover:ring-blue-500">
            DK
          </button>
